          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-900 p-4 rounded-lg">
              ...
              <p className="text-gray-400 text-sm">
                Based on your data, the best time to send emails is between 9 AM
                and 3 PM when engagement rates are highest.
              </p>
            </div>
            ...
            <div className="bg-gray-900 p-4 rounded-lg">
              ...
              <p className="text-gray-400 text-sm">
                Emails with subject lines containing 6-10 words have 21% higher
                open rates. Keep subjects concise and action-oriented.
              </p>
            </div>
            ...
            <div className="bg-gray-900 p-4 rounded-lg">
              ...
              <p className="text-gray-400 text-sm">
                32% of your audience reads emails on mobile devices. Ensure all
                emails are responsive and test on multiple screen sizes.
              </p>
            </div>
            ...
            <div className="bg-gray-900 p-4 rounded-lg">
              ...
              <p className="text-gray-400 text-sm">
                Segmented campaigns perform 58% better than non-segmented ones.
                Consider dividing your audience based on their interaction
                history.
              </p>
            </div>
          </div>
